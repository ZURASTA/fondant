defmodule Fondant.Service.Filter.Type.CuisineTest do
    ...
    setup do
        ...
        foo = Fondant.Service.Repo.insert!(%Cuisine.Model{ ref: "foo", ref_id: Ecto.UUID.generate(), name: 1 + 12, region_id: region_foo.id })
        foobar = Fondant.Service.Repo.insert!(%Cuisine.Model{ ref: "foobar", ref_id: Ecto.UUID.generate(), name: 2 + 12, region_id: region_foobar.id })
        bar = Fondant.Service.Repo.insert!(%Cuisine.Model{ ref: "bar", ref_id: Ecto.UUID.generate(), name: 3 + 12, region_id: region_bar.id })
