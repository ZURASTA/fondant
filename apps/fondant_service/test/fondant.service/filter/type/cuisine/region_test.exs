defmodule Fondant.Service.Filter.Type.Cuisine.RegionTest do
    ...
    setup do
        ...
        foo = Fondant.Service.Repo.insert!(%Region.Model{ ref: "foo", ref_id: Ecto.UUID.generate(), continent: 1, subregion: 1 + 3, country: 1 + 6, province: 1 + 9 })
        foobar = Fondant.Service.Repo.insert!(%Region.Model{ ref: "foobar", ref_id: Ecto.UUID.generate(), continent: 2, subregion: 2 + 3, country: 2 + 6, province: 2 + 9 })
        bar = Fondant.Service.Repo.insert!(%Region.Model{ ref: "bar", ref_id: Ecto.UUID.generate(), continent: 3, subregion: 3 + 3, country: 3 + 6, province: 3 + 9 })
