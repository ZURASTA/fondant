defmodule Fondant.Service.Filter.Type.IngredientTest do
    ...
    setup do
        ...
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 1, locale_id: aa.id, term: "foo_name_aa" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 1, locale_id: zz.id, term: "foo_name_zz" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 1, locale_id: aa_bb.id, term: "foo_name_aa_bb" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 2, locale_id: aa.id, term: "foobar_name_aa" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 2, locale_id: zz.id, term: "foobar_name_zz" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 2, locale_id: aa_bb.id, term: "foobar_name_aa_bb" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 3, locale_id: aa.id, term: "bar_name_aa" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 3, locale_id: zz.id, term: "bar_name_zz" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Name.Model{ translate_id: 3, locale_id: aa_bb.id, term: "bar_name_aa_bb" })

        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 1 + 3, locale_id: aa.id, term: "foo_type_aa" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 1 + 3, locale_id: zz.id, term: "foo_type_zz" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 1 + 3, locale_id: aa_bb.id, term: "foo_type_aa_bb" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 2 + 3, locale_id: aa.id, term: "foobar_type_aa" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 2 + 3, locale_id: zz.id, term: "foobar_type_zz" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 2 + 3, locale_id: aa_bb.id, term: "foobar_type_aa_bb" })
        Fondant.Service.Repo.insert!(%Ingredient.Translation.Type.Model{ translate_id: 3 + 3, locale_id: aa.id, term: "bar_type_aa" })
