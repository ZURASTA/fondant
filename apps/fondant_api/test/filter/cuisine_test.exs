defmodule Fondant.API.Filter.CuisineTest do
    use Fondant.Service.Case

    alias Fondant.API.Filter.Cuisine
    alias Fondant.API.Filter.Cuisine.Region
    ...
    setup do
        ...
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 1, locale_id: aa.id, term: "foo_continent_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 1, locale_id: zz.id, term: "foo_continent_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 1, locale_id: aa_bb.id, term: "foo_continent_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 2, locale_id: aa.id, term: "foobar_continent_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 2, locale_id: zz.id, term: "foobar_continent_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 2, locale_id: aa_bb.id, term: "foobar_continent_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 3, locale_id: aa.id, term: "bar_continent_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 3, locale_id: zz.id, term: "bar_continent_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Continent.Model{ translate_id: 3, locale_id: aa_bb.id, term: "bar_continent_aa_bb" })

        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 1 + 3, locale_id: aa.id, term: "foo_subregion_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 1 + 3, locale_id: zz.id, term: "foo_subregion_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 1 + 3, locale_id: aa_bb.id, term: "foo_subregion_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 2 + 3, locale_id: aa.id, term: "foobar_subregion_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 2 + 3, locale_id: zz.id, term: "foobar_subregion_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 2 + 3, locale_id: aa_bb.id, term: "foobar_subregion_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 3 + 3, locale_id: aa.id, term: "bar_subregion_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 3 + 3, locale_id: zz.id, term: "bar_subregion_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Subregion.Model{ translate_id: 3 + 3, locale_id: aa_bb.id, term: "bar_subregion_aa_bb" })

        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 1 + 6, locale_id: aa.id, term: "foo_country_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 1 + 6, locale_id: zz.id, term: "foo_country_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 1 + 6, locale_id: aa_bb.id, term: "foo_country_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 2 + 6, locale_id: aa.id, term: "foobar_country_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 2 + 6, locale_id: zz.id, term: "foobar_country_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 2 + 6, locale_id: aa_bb.id, term: "foobar_country_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 3 + 6, locale_id: aa.id, term: "bar_country_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 3 + 6, locale_id: zz.id, term: "bar_country_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Country.Model{ translate_id: 3 + 6, locale_id: aa_bb.id, term: "bar_country_aa_bb" })

        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 1 + 9, locale_id: aa.id, term: "foo_province_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 1 + 9, locale_id: zz.id, term: "foo_province_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 1 + 9, locale_id: aa_bb.id, term: "foo_province_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 2 + 9, locale_id: aa.id, term: "foobar_province_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 2 + 9, locale_id: zz.id, term: "foobar_province_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 2 + 9, locale_id: aa_bb.id, term: "foobar_province_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Translation.Province.Model{ translate_id: 3 + 9, locale_id: aa.id, term: "bar_province_aa" })
        ...
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 1 + 12, locale_id: aa.id, term: "foo_name_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 1 + 12, locale_id: zz.id, term: "foo_name_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 1 + 12, locale_id: aa_bb.id, term: "foo_name_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 2 + 12, locale_id: aa.id, term: "foobar_name_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 2 + 12, locale_id: zz.id, term: "foobar_name_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 2 + 12, locale_id: aa_bb.id, term: "foobar_name_aa_bb" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 3 + 12, locale_id: aa.id, term: "bar_name_aa" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 3 + 12, locale_id: zz.id, term: "bar_name_zz" })
        Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Translation.Name.Model{ translate_id: 3 + 12, locale_id: aa_bb.id, term: "bar_name_aa_bb" })

        region_foo = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Model{ ref: "foo", ref_id: Ecto.UUID.generate(), continent: 1, subregion: 1 + 3, country: 1 + 6, province: 1 + 9 })
        region_foobar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Model{ ref: "foobar", ref_id: Ecto.UUID.generate(), continent: 2, subregion: 2 + 3, country: 2 + 6, province: 2 + 9 })
        region_bar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Region.Model{ ref: "bar", ref_id: Ecto.UUID.generate(), continent: 3, subregion: 3 + 3, country: 3 + 6, province: 3 + 9 })

        foo = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Model{ ref: "foo", ref_id: Ecto.UUID.generate(), name: 1 + 12, region_id: region_foo.id })
        foobar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Model{ ref: "foobar", ref_id: Ecto.UUID.generate(), name: 2 + 12, region_id: region_foobar.id })
        bar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Cuisine.Model{ ref: "bar", ref_id: Ecto.UUID.generate(), name: 3 + 12, region_id: region_bar.id })
