defmodule Fondant.API.Filter.DietTest do
    ...
    setup do
        ...
        foo = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Diet.Model{ name: 1 })
        foobar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Diet.Model{ name: 2 })
        bar = Fondant.Service.Repo.insert!(%Fondant.Service.Filter.Type.Diet.Model{ name: 3 })
